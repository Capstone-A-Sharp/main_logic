...
| `handle_calibration()` | 보정 중 압력 min/max 추적                     | 보정 모드 동안 값 기록                 |
| `finalize_calibration()` | 보정 종료 시 기준 압력값 확정 및 적용            | 보정 완료 처리                        |
...
| 함수/메서드명                   | 설명                                          | 용도                        |
|-------------------------------|---------------------------------------------|-----------------------------|
| `update_pressure_extremes()` | 보정 중 압력 평균값의 최소/최댓값을 계속 갱신          | 실시간 압력 경계 수집           |
